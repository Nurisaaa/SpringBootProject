...
public class CourseApi {
    ...
    @PostMapping
    public CourseResponse saveCourse(@RequestBody CourseRequest courseRequest, @PathVariable("compId") Long id) {
        return courseService.saveCourse(id, courseRequest);
    }

    @PatchMapping("update/{id}")
    public CourseResponse updateCourse(@RequestBody CourseRequest courseRequest, @PathVariable("id") Long id) {
